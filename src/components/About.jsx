    ...
    <>
      <div className="tokyo_tm_about">
        ...
        <div className="description">
          <h3 className="name">Roman &amp; developer</h3>
            ...
            <div className="right">
              <ul>
                ...
                <li>
                  <p>
                    <span>Phone:</span>
                    <a href="tel:+77071033382">+77071033382</a>
                  </p>
                </li>
                <li>
                  <p>
                    <span>Study:</span>Wien
                  </p>
                </li>
                <li>
                  <p>
                ...
                <div className="right">
                  ...
                  <div className="tokyo_progress">
                    ...
                    <div className="progress_inner" data-value="85">
                      <span>
                        <span className="label">Russisch</span>
